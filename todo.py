#Simple To-Do List App with Python tkinter
#By Tandap Noel Bansikah
...
root = tkinter.Tk()
root.title("To Do List by Noel Draxler")
...
def load_tasks():
    try:
        ...
        tkinter.messagebox.showwarning(title="Warning!", message="Can not find tasks.dat file")
